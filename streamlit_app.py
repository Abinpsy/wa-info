...
st.set_page_config(
    ...
    menu_items={
        'Report a bug': "https://0ab.in",
        'About': "# This is an Whatsapp Group Chat Analyzer!"
    }
)
def show_github_sponsor():
    st.markdown("""
        <a href="https://0ab.in" style="text-decoration: none;">
...
with st.expander("🌟 Discover the Magic Behind This App"):
    ...
    - Open source: You can view our source code on [GitHub](https://0ab.in).

    - Acknowledgements: 
      - Thanks to [ABIN](https://wa.me/919207189625) for their WhatsApp parsing tool.
      - Thanks to [JACK](https://0ab.in) for inspiration.
...
def app():
    ...
    if "df" not in session_state:
        ...
        def read_sample_data():
            df = pd.read_csv(
                "data/sample_file.txt", header=None)
